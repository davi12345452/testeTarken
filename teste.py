...
# Aplicando a dilatação nos pontos brancos e cinza
elemento_estruturante = cv2.getStructuringElement(cv2.MORPH_RECT, (4, 4))
imagem_engrossada = cv2.dilate(imagem_resultado, elemento_estruturante, iterations=1)

cv2.imshow('Imagem Resultado', imagem_engrossada)
cv2.waitKey(0)
cv2.destroyAllWindows()